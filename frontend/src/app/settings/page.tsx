...
import { Settings, Cpu, HardDrive, Shield, Bell, Key } from "lucide-react"
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <div>
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-bold text-white tracking-tight">Sistem & Model Ayarları</h1>
        ...
        <p className="text-xs text-zinc-400 mt-1">
          Yapay zeka modeli, donanım hızlandırma ve entegrasyon parametreleri
        </p>
      </div>
